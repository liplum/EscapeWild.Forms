...
namespace WildernessSurvival.Localization
{
    public class LangZhCn : ILocalization
    {
        ...
        public Dictionary<string, string> TranslationKey2Localized { get; } = new Dictionary<string, string>
        {
            ...
            { "Item.PlasticBottle.Name", "塑料瓶" },
            { "Item.PlasticBottle.Desc", "来自现代工业的最好的礼物。" },
            ...
            { "Item.Nuts.Name", "坚果" },
            { "Item.Nuts.Desc", "芜香蛋。" },
            { "Item.ToastedNuts.Name", "烤坚果" },
            { "Item.ToastedNuts.Desc", "我裂开了。" },
            ...
            { "Item.Sticks.Name", "树枝" },
            { "Item.Sticks.Desc", "平平无奇的树枝。" },
            { "Item.CutGrass.Name", "割下的草" },
            { "Item.CutGrass.Desc", "别担心，这还是绿色可再生资源。" },
            { "Item.HandDrillKit.Name", "钻木取火套件" },
            { "Item.HandDrillKit.Desc", "这可没有荒野求生系列剧那么简单。" },
            { "Item.UnknownMushrooms.Name", "不明的蘑菇" },
            { "Item.UnknownMushrooms.Desc", "最好别碰鲜艳的蘑菇，好吧，就尝一下。" },
            { "Item.GrilledUnknownMushrooms.Name", "烤过的不明蘑菇" },
            { "Item.GrilledUnknownMushrooms.Desc", "希望现在没有毒了。" },
            { "Cook.Cook", "烹饪" },
            { "Cook.Boil", "煮沸" },
            { "Cook.Roast", "炙烤" },
            { "Cook.Tip", "选择要加热的东西" },
            ...
            { "Craft.Tip", "选择一个进行制作" },
            { "Craft.Craft", "制作" },
            { "Craft.AfterCraft", "制作后" },
            { "Fire.Header", "篝火" },
            { "Fire.Throw", "扔入" },
            { "Fire.Tip", "选择物品作为燃料" },
            { "Fire.Fuel", "燃料" },
            { "Fire.Success", "哇，你生了一团火！" },
            { "Fire.Failed.Wet", "这里太潮湿了，你最好换个地方。" },
            { "Fire.Failed.FireRate", "不太行，你没点着火。" },
            { "Fire.PutOut.Move", "是时候出发了，你熄灭了火堆。" },
            { "Backpack.Header", "背包" },
            { "Backpack.CannotUse", "不可使用" },
            { "Backpack.Use", "使用" },
            { "Backpack.Eat", "食用" },
            { "Backpack.Tip", "选择要使用的物品" },
            { "Backpack.Drink", "饮用" },
            { "Backpack.AfterUse", "使用后" },
            { "Backpack.AfterEat", "食用后" },
            { "Backpack.AfterDrink", "饮用后" },
            { "Dialog.Failed.Title", "失败" },
            { "Dialog.Failed.Content", "你死了，但你撑过了 {0} 次行动。" },
            { "Dialog.Failed.Accept", "重新开始" },
            { "Dialog.Failed.Cancel", "再等等" },
            { "Dialog.Win.Title", "恭喜！" },
            { "Dialog.Win.Content", "经过了 {0} 次行动，你成功逃离了荒野！" },
